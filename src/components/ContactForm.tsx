...
import { BsFacebook, BsInstagram, BsLinkedin, BsPerson, BsTwitter, BsWhatsapp } from 'react-icons/bs';
...
const confetti = {
  ...
  dark: {
    primary: '652B19', // orange.900
    secondary: '7B341E', // orange.800
  },
};
...
export function ContactForm() {
  const { hasCopied, onCopy } = useClipboard("jakson.reis@hotmail.com");
          ...
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            ...
            <Stack
              ...
              <Stack
                ...
                <Link href="https://www.instagram.com/jakson_reis" isExternal>
                  <IconButton
                ...
                <Link href="https://api.whatsapp.com/send?phone=5538999336995" isExternal>
                  <IconButton
                    aria-label="whatsapp"
                    variant="ghost"
                    size="lg"
                ...
                <Link href="https://www.facebook.com/jakson.reis.54/" isExternal>
                  <IconButton
                    aria-label="facebook"
                    variant="ghost"
                    size="lg"
                ...
                <Link href="https://www.linkedin.com/in/jakson-reis-024b3b16a/" isExternal >
                  <IconButton
                    aria-label="linkedin"
                    variant="ghost"
                    size="lg"
              ...
              <Box
                ...
                shadow="base"
                w={["80vw","75vw","50vw"]}>
                <form id="contactform" action="https://formsubmit.co/jakson.reis@hotmail.com" method="post">
                  <input type="hidden" name="_captcha" value="false" />
                  <input type="hidden" name="_next" value="https://jaksonreis.github.io/sended" />
